...
fun daysInMonth(month: Int, year: Int): Int {
    val list31: List<Int> = listOf(1, 3, 5, 7, 8, 10, 12)
    val list30: List<Int> = listOf(4, 6, 9, 11)
    println("${year % 4}, ${month == 2 && (year % 4 == 0)}")
    return if (month in list31) 31
    else if (month in list30) 30
    else if (month == 2 && year % 4 == 0) {
        if (year % 100 == 0 && year % 400 == 0) 29
